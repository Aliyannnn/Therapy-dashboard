...
// Validate ../../../app/admin/create-user/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/admin/create-user">> = Specific
  const handler = {} as typeof import("../../../app/admin/create-user/page.js")
